...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">自动化办公系统---- OA在线办公</font> 
			<!--<img border="0" src="${pageContext.request.contextPath}/css/blue/images/logo.png" />-->
        </div>
		
		<div id="Head1Right">
			<div id="Head1Right_UserName">
                <img border="0" width="13" height="14" src="${pageContext.request.contextPath}/css/images/top/user.gif" /> 您好，<b>${user.username}</b>
			</div>
        ...
        <div id="Head1Right_SystemButton">
            <a target="_parent" href="userAction_logOut.action">
